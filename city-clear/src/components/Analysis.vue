<template>
    <div class="analysis">
        ...
        <h2>Comune di {{this.district}}</h2>
        <h4>Provincia: {{this.province}}, Regione: {{this.area}}</h4>
        <v-icon name="users"></v-icon> {{this.cityPerson}} <br><br>
           <b-row order="1">
                <center>
           ...
           <b-row order="3">
                <center>
                    <h2>Totale punti caldi in mappa: {{this.hotPoint}}</h2>
                </center>
            </b-row>
        </div>
    </div>
